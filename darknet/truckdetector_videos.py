...
def parser():
    ...
    parser.add_argument("--input", type=str, default="../test_videos/GHmendung/ghmendung1.mp4",
...
def drawing(frame_queue, detections_queue, fps_queue):
    ...
    while cap.isOpened():
        ...
        if frame is not None:
            ...
            # for item in detections_adjusted:
            #     if item[0] == 'truk_odol':
            #         save_odol(item,frame)
...
def save_odol(truckodolInfo,image):
...
if __name__ == '__main__':
    ...
    video_width = int(cap.set(3,1280))
    #video_height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
    video_height = int(cap.set(4,720))
